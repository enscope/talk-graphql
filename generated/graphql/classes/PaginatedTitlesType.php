 ...
 */
final class PaginatedTitlesType extends ObjectType implements GeneratedTypeInterface
{
    ...
    public function __construct(ConfigProcessor $configProcessor, GlobalVariables $globalVariables = null)
    {
        $configLoader = function(GlobalVariables $globalVariable) {
            ...
            'resolveField' => function ($value, $args, $context, ResolveInfo $info) use ($globalVariable) {
                return $globalVariable->get('resolverResolver')->resolve(["App\\GraphQL\\Resolver\\PaginatedTitlesResolver", [0 => $info, 1 => $value, 2 => $args]]);
            },
        ];
        };
